...
<% String id = (String) request.getParameter(Control.PARAM_ID); %>
...
<form action="<%= request.getContextPath() %>/control" method="POST">
	...
	<input type="hidden" name="<%= Control.PARAM_ID2 %>" value="<%= id %>">
	...
	<div class="form-group row">
		<label class="col-sm-2 col-form-label">Nueva Plataforma:</label>
		<div class="col-sm-10">
